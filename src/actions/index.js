import { SET_USER, SET_WALLET, SET_WALLET_SUCCESS, SET_WALLET_FAIL,
  SET_EXPENSES, SET_SUM, SET_LOADING, SET_CURRENCIES_INFO, MIN_EXPENSES } from './actionTypes';
...
export const setCurrenciesInfo = (payload) => ({
  type: SET_CURRENCIES_INFO, payload,
});

export const minExpenses = (value) => ({
  type: MIN_EXPENSES, value,
});
